...
export default function Footer(props: StaticPageProps) {
  return (
        ...
        <div class={styles.grid}>
          <div class={styles.about}>
            ...
            <ol class={styles.socialList}>
              ...
              <li class={styles.socialElement}>
                <a
                  href="https://instagram.com/codepunkt"
                  aria-label="Instagram profile"
                  class={styles.socialLink}
                >
                  <svg
                    class={styles.socialInstagram}
                    role="img"
                    viewBox="0 0 512 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <li class={styles.socialElement}>
                <a
                  href="https://www.linkedin.com/in/christophwerner/"
                  aria-label="LinkedIn profile"
                  class={styles.socialLink}
                >
                  <svg
                    class={styles.socialLinkedin}
                    role="img"
                    viewBox="0 0 512 512"
                    xmlns="http://www.w3.org/2000/svg"
                  >
          ...
          {props.translations.length > 0 && (
            <div class={styles.translations}>
              <div class={styles.translationsHeader}>{'language - select'}</div>
              <ul>
                {props.translations.map((t) => {
                  return (
                    <li>
                      <a href={t.route}>{t.languageName}</a>
                      &nbsp;&nbsp;
                      {t.languageId === props.language ? '✓' : ''}
                    </li>
                  )
                })}
              </ul>
              ...
              {menuEntries.map(({ url, name }) => {
                ...
                return (
                  <li key={translatedName}>
                    <a href={url}>{translatedName}</a>
                  </li>
                )
              })}
              <li>
                <a href="/writing/rss.xml">Feed</a>
              </li>
              <li>
